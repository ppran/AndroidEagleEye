...
public class ActivityManagerHook extends MethodHook {
	...
	private enum Methods {
		getRecentTasks, getRunningAppProcesses, getRunningServices, getRunningTasks,isLowRamDevice,getMemoryClass,
		moveTaskToFront,getRunningServiceControlPanel,getLargeMemoryClass,getMyMemoryState,getLockTaskModeState,addAppTask,killBackgroundProcesses,
		getAppTasks,isInLockTaskMode,isUserAMonkey,dumpPackageState,getPackageImportance,restartPackage,getDeviceConfigurationInfo,clearApplicationUserData,
		getCurrentUser
	};
