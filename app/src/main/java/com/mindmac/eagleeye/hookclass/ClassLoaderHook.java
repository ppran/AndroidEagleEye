...
public class ClassLoaderHook extends MethodHook {
	...
	private enum Methods {
		loadClass,findResource,getSystemResource,findResources,getPackages,getSystemClassLoader,
		getSystemResourceAsStream, findSystemClass, getPackage, defineClass, getResources, resolveClass,
		findLoadedClass, findLibrary, setPackageAssertionStatus, setClassAssertionStatus, getParent
