...
public class AccountManagerHook extends MethodHook {
	...
	private enum Methods {
		getAccounts, getAccountsByType, getAccountsByTypeForPackage,updateCredentials,renameAccount,
		getAccountsByTypeAndFeatures, getAuthToken, getAuthTokenByFeatures,notifyAccountAuthenticated
	};
